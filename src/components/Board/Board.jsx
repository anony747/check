...
import optionsIcon from '../../assets/icons/3 dot menu.svg';
import Card from '../Card/Card';
import UserIcon from '../UserIcon/UserIcon';
import { ReactComponent as UrgentCardIcon } from '../../assets/icons/SVG - Urgent Priority grey.svg';
                ...
                <div className="board_container">
                    {
                        filteredTickets.map((ticket) => {
                            const priorityIcon = (ticket?.priority == 4)
                                ? <UrgentCardIcon />
